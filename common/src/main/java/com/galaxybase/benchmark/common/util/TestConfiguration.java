...
public final class TestConfiguration {
    ...
    private static String homePath = resourcePath() + "/";
...
//    private String prop;
    private static String filename = "janus-application.yaml";
    ...
    public static String resourcePath() {
        ...
        return new File(resourcePath).getPath();
    }
    ...
    public static TestConfiguration initConfiguation(String path) {
        return new TestConfiguration(path, filename);
    }
